...
public class ProgramMethods {
    ...
    public void NewClient() throws ClassNotFoundException {
        ...
        while (contLoop) {
            ...
            System.out.println("---------------------------------------\n" + "              CLIENT INFO\n"
                    ...
                    + "2. NO");
                    Client client = new Client(name, surname, pnumber, email);
    ...
    public void NewEvent() {
        ...
        while (contloop) {
            ...
            System.out.println("-------------------------------\n" + "EVENT NAME:\t" + eventname + "\n"
                    ...
                    + "VENUE ADDRESS:\t" + venueaddress + "\n" + "VENUE PHONENUMBER:\t" + venuepnumber + "\n"
                    + "WANT DECORATIONS?:\t" + decorations + "\n" + "DECORATION THEME:\t" + theme + "\n"
                    + "DECOR DETAILS:\t" + decordetails + "\n" + "FOOD" + "ADULT MEAL:\t" + adultmeal + " FOR "
                    + adultpersons + " PERSONS" + "KIDS MEAL:\t" + kidsmeal + " FOR " + kidspersons + " PERSONS"
                    + "DRINKS:\t" + drinkchoice + " FOR " + drinkpersons + " PERSONS" + "DESSERTS:\t" + dessertmeal
                    + " FOR " + dessertpersons + " PERSONS" + "TOTAL PRICE:\tR" + totalprice
                    + "-------------------------------");
            boolean ynloop = true;
            while (ynloop) {
                System.out.println("IS THIS INFORMATION CORRECT?\n" + "1. YES\n" + "2. NO");
